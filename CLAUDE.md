...
- **Pace for a NATURAL, unhurried delivery: ~2.3–2.5 words/second — NOT 3.** Packing near 3 words/sec makes him rush, slur/mispronounce words, and sound like a rushed ad read. Budget only ~35 words for a relaxed 15s clip; if the script is longer, EXTEND the duration (e.g. 45 words → ~19–20s) rather than cram it into 15s. Space the beats with a little breathing room between sentences, and always add explicit delivery cues like "relaxed, unhurried pace, takes his time, natural pauses between sentences, never rushed." When a script would rush at the requested length, FLAG it and offer more seconds (preferred) or a trim.
