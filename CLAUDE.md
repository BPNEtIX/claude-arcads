...
- **NEVER have the person HOLD the phone at arm's length ("true selfie").** Seedance has to bend the selfie arm up and BACK toward the camera and it warps/mangles it almost every time (distorted arm behind the shoulder, extra/melted limb). It still costs a full generation. Instead **PROP the phone** (on the table / a stand) at selfie height filming them — it reads exactly like a selfie/UGC video, vertical, talking to camera, but there's no reaching arm to warp. Both their hands stay free and natural. If the user insists on a held-phone selfie, warn them the arm will likely warp before generating.
